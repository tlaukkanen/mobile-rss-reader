...
//#endif
{
	...
	*/
	...
	//#endif
	//#ifdef DLOGGING
    final private Logger logger = Logger.getLogger("compatibility4.EncodingUtil");
	...
	public static String replaceSpUniWinChars(String text) {
		//#ifdef DLOGGING
        Logger.getLogger("EncodingUtil").trace("replaceSpUniWinChars text=" + text);
		//#endif
		try {
	...
	public static String replaceSpUniChars(String text) {
		//#ifdef DLOGGING
        Logger.getLogger("EncodingUtil").trace("replaceSpUniChars text=" + text);
		//#endif
