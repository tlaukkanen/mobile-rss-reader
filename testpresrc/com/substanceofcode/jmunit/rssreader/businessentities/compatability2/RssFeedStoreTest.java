...
package com.substanceofcode.jmunit.rssreader.businessentities.compatibility2;
...
import com.substanceofcode.rssreader.businessentities.compatibility2.RssFeed;
import com.substanceofcode.rssreader.businessentities.compatibility2.RssItem;

final public class RssFeedStoreTest extends BaseTestCase {

	public RssFeedStoreTest() {
		super(5, "compatibility2.RssFeedStoreTest");
	}
	...
	public RssFeed feed2StoreTestStrFactory(String mname,
			String step, int nbr,
			String suffix,
			long ldate,
	...
	public RssFeedStoreHolder feedStoreTestStrSub(String mname, int nbr, String suffix,
		...
		try {
			...
			com.substanceofcode.rssreader.businessentities.RssItunesFeed feed = feedStoreStrFactory(mname,
									"1", nbr, suffix + "z",
									isItunes, ldate, explicit, litem1Date,
									explicit1, litem2Date, explicit2);

			RssFeed infoFeed = feed2StoreTestStrFactory(mname,
									"2", nbr, suffix,
									ldate, litem1Date,
									litem2Date);
			assertFalse(mname +
    ...
    public void storeStringTestSub(final String mname,
		...
		try {
			...
			com.substanceofcode.rssreader.businessentities.RssItunesFeed nfeed =
				new com.substanceofcode.rssreader.businessentities.RssItunesFeed(
						new com.substanceofcode.rssreader.businessentities.RssFeed(false,
						encoded, storeString));
			//#ifdef DLOGGING
