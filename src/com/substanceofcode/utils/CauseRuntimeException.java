 ...
 */
public class CauseRuntimeException extends
//#ifdef DLOGGING
...
//#endif
{
    ...
    public CauseRuntimeException() {
		super();
    }

    public CauseRuntimeException(String message) {
		super(message);
		causeSet = true;
    }

    public CauseRuntimeException(String message, Throwable cause) {
		super(message);
		this.cause = cause;
		causeSet = true;
    }
