...
//#endif
{
	...
	//#ifdef DLOGGING
    private Logger logger = Logger.getLogger("compatibility3.RssItunesItem");
	...
	public boolean equals(RssItemInfo pitem) {
		...
		if (!TestLogUtil.fieldEquals(item.getExplicit().toUpperCase(),
					convExplicit(m_explicit).toUpperCase(),
